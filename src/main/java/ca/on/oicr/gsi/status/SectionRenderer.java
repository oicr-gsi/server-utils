...
/** Interface to create the rows of a table in a configuration block on the status page. */
public interface SectionRenderer {

  /**
   * Write a row in the table with text that executes some JavaScript code when clicked in the
   * second column
   */
  void javaScriptLink(String header, String code, String value);

  /**
   * Write a row in the table with the supplied value in the second column; apply the supplied
   * attributes to the <tt>TR</tt>
   */
  ...
  /**
   * Write a row in the table with the delay between the present time and the supplied value in the
   * second column
   */
