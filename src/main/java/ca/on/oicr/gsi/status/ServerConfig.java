...
public interface ServerConfig {
   ...
   *
   * <p>This should be the name of the server software rather than an instance
   */
  String name();
  ...
  /**
   * @return the URL path to API documentation, relative to the context root. Defaults to
   *     "api-docs/index.html"
   */
