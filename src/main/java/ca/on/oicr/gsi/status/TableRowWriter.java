...
public final class TableRowWriter {
   ...
   *
   * @param header whether the row should be a header <tt>TR</tt> or a data row <tt>TD</tt>
   * @param row the values that appear in the columns
   */
   ...
   *
   * @param attributes any HTML attribute that should be applied to the <tt>TR</tt> tag
   * @param row the values that appear in the columns
   */
